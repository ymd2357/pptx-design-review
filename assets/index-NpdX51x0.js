import{r as l,s as o}from"./site-path-CpQztevh.js";import{l as m}from"./contents-BSzOdijY.js";const d=document.querySelector("#app");if(!d)throw new Error("Missing #app");const r=d;(async()=>(await l(r),await u()))();async function u(){r.replaceChildren(s("レビューを読み込み中..."));const t=await m(),e=s("");e.append(h(t)),r.replaceChildren(e)}function s(t){const e=document.createElement("main");e.className="app-shell";const n=document.createElement("header");if(n.className="app-header",n.innerHTML=`
    <div>
